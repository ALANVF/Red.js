...
export default class Vector_Percent64 extends VectorOf<"percent!", 64> {
	constructor(values: number[] | Float64Array) {
		super("percent!", 64, values);
	}
	...
	copy(): Vector_Percent64 {
		return new Vector_Percent64([...this.repr]);
	}
	
	copyAs(fn: (v: Float64Array) => Float64Array): Vector_Percent64 {
		return new Vector_Percent64(fn(this.repr));
	}

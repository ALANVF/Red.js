...
any-object!:	make typeset! [context! object!] ;error! port!]
...
immediate!:		union scalar! union all-word! make typeset! [none! logic! datatype! typeset! date!]

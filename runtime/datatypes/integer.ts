...
export function $$add(
	...
	if(right instanceof Red.RawInteger) {
		...
		throw TypeError("Can't add integer! with type " + Red.TYPE_NAME(right));
	}
}
...
export function $$subtract(
	...
	if(right instanceof Red.RawInteger) {
		...
		throw TypeError("Can't subtract integer! with type " + Red.TYPE_NAME(right));
	}
}
...
export function $$multiply(
	...
	if(right instanceof Red.RawInteger) {
		...
		throw TypeError("Can't multiply integer! with type " + Red.TYPE_NAME(right));
	}
}
...
export function $$divide(
	...
	if(right instanceof Red.RawInteger) {
		...
		throw TypeError("Can't divide integer! with type " + Red.TYPE_NAME(right));
	}
}
...
export function $$remainder(
	...
	if(right instanceof Red.RawInteger) {
		...
		throw TypeError("Can't get the remainder of integer! with type " + Red.TYPE_NAME(right));
	}
}

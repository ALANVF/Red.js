...
abstract UInt8ClampedArray(UInt8ClampedArrayData) to js.lib.ArrayBufferView {
	...
	public static overload extern inline function from(values: js.lib.Int8Array): UInt8ClampedArray return cast Data.from(values);
	public static overload extern inline function from(values: js.lib.Int8Array, fn: (v: Int) -> Int): UInt8ClampedArray return cast Data.from(values, fn);
	public static overload extern inline function from(values: js.lib.Int8Array, fn: (v: Int, i: Int) -> Int): UInt8ClampedArray return cast Data.from(values, fn);
	public static overload extern inline function from(values: js.lib.Uint8Array): UInt8ClampedArray return cast Data.from(values);
	public static overload extern inline function from(values: js.lib.Uint8Array, fn: (v: Int) -> Int): UInt8ClampedArray return cast Data.from(values, fn);
	public static overload extern inline function from(values: js.lib.Uint8Array, fn: (v: Int, i: Int) -> Int): UInt8ClampedArray return cast Data.from(values, fn);
	public static overload extern inline function from(values: js.lib.Uint8ClampedArray): UInt8ClampedArray return cast Data.from(values);
	public static overload extern inline function from(values: js.lib.Uint8ClampedArray, fn: (v: Int) -> Int): UInt8ClampedArray return cast Data.from(values, fn);
	public static overload extern inline function from(values: js.lib.Uint8ClampedArray, fn: (v: Int, i: Int) -> Int): UInt8ClampedArray return cast Data.from(values, fn);
	public static overload extern inline function from(values: js.lib.Int16Array): UInt8ClampedArray return cast Data.from(values);
	public static overload extern inline function from(values: js.lib.Int16Array, fn: (v: Int) -> Int): UInt8ClampedArray return cast Data.from(values, fn);
	public static overload extern inline function from(values: js.lib.Int16Array, fn: (v: Int, i: Int) -> Int): UInt8ClampedArray return cast Data.from(values, fn);
	public static overload extern inline function from(values: js.lib.Uint16Array): UInt8ClampedArray return cast Data.from(values);
	public static overload extern inline function from(values: js.lib.Uint16Array, fn: (v: Int) -> Int): UInt8ClampedArray return cast Data.from(values, fn);
	public static overload extern inline function from(values: js.lib.Uint16Array, fn: (v: Int, i: Int) -> Int): UInt8ClampedArray return cast Data.from(values, fn);
	public static overload extern inline function from(values: js.lib.Int32Array): UInt8ClampedArray return cast Data.from(values);
	public static overload extern inline function from(values: js.lib.Int32Array, fn: (v: Int) -> Int): UInt8ClampedArray return cast Data.from(values, fn);
	public static overload extern inline function from(values: js.lib.Int32Array, fn: (v: Int, i: Int) -> Int): UInt8ClampedArray return cast Data.from(values, fn);
	public static overload extern inline function from(values: js.lib.Uint32Array): UInt8ClampedArray return cast Data.from(values);
	public static overload extern inline function from(values: js.lib.Uint32Array, fn: (v: Int) -> Int): UInt8ClampedArray return cast Data.from(values, fn);
	public static overload extern inline function from(values: js.lib.Uint32Array, fn: (v: Int, i: Int) -> Int): UInt8ClampedArray return cast Data.from(values, fn);
	public static overload extern inline function from(values: js.lib.Float32Array): UInt8ClampedArray return cast Data.from(values);
	public static overload extern inline function from(values: js.lib.Float32Array, fn: (v: Float) -> Int): UInt8ClampedArray return cast Data.from(values, fn);
	public static overload extern inline function from(values: js.lib.Float32Array, fn: (v: Float, i: Int) -> Int): UInt8ClampedArray return cast Data.from(values, fn);
	public static overload extern inline function from(values: js.lib.Float64Array): UInt8ClampedArray return cast Data.from(values);
	public static overload extern inline function from(values: js.lib.Float64Array, fn: (v: Float) -> Int): UInt8ClampedArray return cast Data.from(values, fn);
	public static overload extern inline function from(values: js.lib.Float64Array, fn: (v: Float, i: Int) -> Int): UInt8ClampedArray return cast Data.from(values, fn);
	public static overload extern inline function from(values: UInt8ClampedArray): UInt8ClampedArray return cast Data.from(values.getData());
	public static overload extern inline function from(values: UInt8ClampedArray, fn: (v: Int) -> Int): UInt8ClampedArray return cast Data.from(values.getData(), fn);
	public static overload extern inline function from(values: UInt8ClampedArray, fn: (v: Int, i: Int) -> Int): UInt8ClampedArray return cast Data.from(values.getData(), fn);
	public static overload extern inline function from(values: Array<Int>): UInt8ClampedArray return cast Data.from(values);
	public static overload extern inline function from(values: Array<Int>, fn: (v: Int) -> Int): UInt8ClampedArray return cast Data.from(values, fn);
	public static overload extern inline function from(values: Array<Int>, fn: (v: Int, i: Int) -> Int): UInt8ClampedArray return cast Data.from(values, fn);

	public static extern inline function of(...values: Int): UInt8ClampedArray return cast Data.of(...values);

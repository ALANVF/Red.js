...
export default class Vector_Percent32 extends VectorOf<"percent!", 32> {
	constructor(values: number[] | Float32Array) {
		super("percent!", 32, values);
	}
	...
	copy(): Vector_Percent32 {
		return new Vector_Percent32([...this.repr]);
	}
	
	copyAs(fn: (v: Float32Array) => Float32Array): Vector_Percent32 {
		return new Vector_Percent32(fn(this.repr));
	}
